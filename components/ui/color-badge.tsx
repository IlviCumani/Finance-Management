...
const COLORS: Record<string, string> = {
    ...
    orange: "bg-orange-600/10 dark:bg-orange-600/20 hover:bg-orange-600/10 text-orange-500 border-orange-600/60 shadow-none",
    amber: "bg-amber-600/10 dark:bg-amber-600/20 hover:bg-amber-600/10 text-amber-500 border-amber-600/60 shadow-none",
    emerald:
    ...
    indigo: "bg-indigo-600/10 dark:bg-indigo-600/20 hover:bg-indigo-600/10 text-indigo-500 border-indigo-600/60 shadow-none",
    purple: "bg-purple-600/10 dark:bg-purple-600/20 hover:bg-purple-600/10 text-purple-500 border-purple-600/60 shadow-none",
    ...
    green: "bg-green-600/10 dark:bg-green-600/20 hover:bg-green-600/10 text-green-500 border-green-600/60 shadow-none",
    blue: "bg-blue-600/10 dark:bg-blue-600/20 hover:bg-blue-600/10 text-blue-500 border-blue-600/60 shadow-none",
    violet: "bg-violet-600/10 dark:bg-violet-600/20 hover:bg-violet-600/10 text-violet-500 border-violet-600/60 shadow-none",
    yellow: "bg-yellow-600/10 dark:bg-yellow-600/20 hover:bg-yellow-600/10 text-yellow-500 border-yellow-600/60 shadow-none",
    gray: "bg-gray-600/10 dark:bg-gray-600/20 hover:bg-gray-600/10 text-gray-500 border-gray-600/60 shadow-none",
    white: "bg-white/10 dark:bg-white/20 hover:bg-white/10 text-white border-white/60 shadow-none",
    black: "bg-black/10 dark:bg-black/20 hover:bg-black/10 text-black border-black/60 shadow-none",
};
...
export function ColorBadge({
    ...
    return (
        <Badge
            className={cn(
                COLORS[color],
                "rounded-full min-w-22 font-bold",
