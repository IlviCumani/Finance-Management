...
export function Table<T>({ table, id, density = "standard" }: TableProps<T>) {
  ...
  function getPinnedColStyle(
    ...
    return {
      ...
      zIndex: isPinned ? 1 : 0,
      backgroundColor:
        isPinned && !isHeader ? "var(--background)" : "transparent",
    }
  }
  ...
  return (
    <div className="overflow-hidden rounded-lg border">
      ...
      >
              ...
              {headerGroup.headers.map((header) => {
                return (
                  <TableHead
                    key={header.id}
                    className="my-2"
                    style={getPinnedColStyle(header.column, true)}
                  >
        ...
        <TableBody className="overflow-y-hidden p-1">
