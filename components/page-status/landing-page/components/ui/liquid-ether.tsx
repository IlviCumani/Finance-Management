...
`
    ...
    class Advection extends ShaderPass {
      ...
      override update(opts?: {
        dt?: number
        isBounce?: boolean
        BFECC?: boolean
      }) {
        const { dt: dtVal, isBounce: bounce, BFECC: bfecc } = opts || {}
    ...
    class Viscous extends ShaderPass {
      ...
      override update(opts?: {
        ...
        const { viscous: v, iterations, dt: dtVal } = opts || {}
        ...
        if (typeof v === "number") this.uniforms.v.value = v
    ...
    class Pressure extends ShaderPass {
      ...
      override update(opts?: {
        ...
        const { vel, pressure: p } = opts || {}
        if (this.uniforms && vel && p) {
          this.uniforms.velocity.value = vel.texture
          this.uniforms.pressure.value = p.texture
        }
        super.update()
      }
    }
    ...
    class Simulation {
      ...
      createAllFBO() {
        ...
        this.fbos = {
          vel_0: makeFBO(),
          vel_1: makeFBO(),
          vel_viscous0: makeFBO(),
          vel_viscous1: makeFBO(),
          div: makeFBO(),
          pressure_0: makeFBO(),
          pressure_1: makeFBO(),
        }
      ...
      resize() {
        this.calcSize()
        for (const key of Object.keys(this.fbos) as Array<
          keyof SimulationFBOs
        >) {
