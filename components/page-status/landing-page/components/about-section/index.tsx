        ...
        <div className="mt-16 grid gap-10 text-left md:grid-cols-3">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Log a transaction in seconds, not minutes. Every screen is
              designed to get out of your way and let you move on with your day.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              No bank logins, no third-party scraping. You enter what you want,
              when you want. Everything is encrypted and stays under your
              control.
            </p>
          </div>
