...
export default function RegisterPage() {
    ...
    return (
        <CardLayout
            ...
            size="xl"
        >
            <form onSubmit={form.handleSubmit(onSubmit)} id="register-form" className="sm:w-full md:w-2xl" >
                <FieldGroup className="grid grid-cols-1 gap-4 md:grid-cols-2 space-y-4 w-full">
                    <Controller
                        name="fullName"
                ...
                <div className="flex flex-col items-center justify-center gap-4 mt-8">
                    <p hidden={!error} className="text-destructive">{error}</p>
