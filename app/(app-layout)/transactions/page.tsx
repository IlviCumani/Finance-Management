...
export default async function TransactionsPage() {
    ...
    return (
        <div>
            <TransactionsHeader accounts={accounts ?? []} transactionCategories={transactionCategories ?? []} />
            <div className="p-4">
                <TransactionTable transactions={data ?? []} accounts={accounts ?? []} transactionCategories={transactionCategories ?? []} />
            </div>
        </div>
    )
}
