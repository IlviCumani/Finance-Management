...
import { createTransactionCategory, updateTransactionCategory } from "../../actions";
import { toast } from "sonner";

const categoryTypes = ["income", "expense", "transfer"] as const satisfies readonly TransactionCategoryType[]
...
export function TransactionCategoryForm({
    ...
    const tValidation = useTranslations("settings.transactionCategories.validation")
    ...
    return (
        ...
        >
            <form onSubmit={form.handleSubmit(onSubmit)} id="transaction-category-form">
                <FieldGroup>
                    <Controller
